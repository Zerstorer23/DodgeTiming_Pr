...
public class BulletManager : MonoBehaviour
{
    ...
    private void InstantiateSpanwer(SpawnDirection spawnDir, MoveType moveType, ReactionType reaction)
    {
        ...
        switch ((MoveType)moveType)
        {
            ...
            case MoveType.Straight:
                ...
                UnityEngine.GameObject spawner = LexNetwork.InstantiateRoomObject("Prefabs/Units/BulletSpawner", randPos, Quaternion.identity,0, new object[] { gameField.fieldNo});
    ...
    private void InstantiateBox()
    {
        ...
        GameObject box = LexNetwork.InstantiateRoomObject("Prefabs/Units/BoxObstacle", randPos, Quaternion.identity,0, new object[] { gameField.fieldNo, randW,randH,spawnDelay });
    ...
    void SetProjectileInformation(GameObject spawner, SpawnDirection spawnDir, MoveType moveType, ReactionType reaction)
    {
        ...
        spawner.GetComponent<LexView>().RPC("SetProjectile",   (int)spawnDir, (int)moveType, (int)reaction,blockSize, moveSpeed, rotateSpeed);
    }
    void SetProjectileBehaviour(GameObject spawner, Vector3 randPos)
    {
        ...
        spawner.GetComponent<LexView>().RPC("SetBehaviour",   headingDirection, angleRange, delay, duration);
    }
